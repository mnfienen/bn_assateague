function [pred, dataIn, dataOut, bh]  = runPredictBayesMNF(netName, nodeNamesIn, nodeNamesOut, data, dataNames, testcasename, dataErr)
...
if(exist('dataErr'))
    ...
    pred = predictBayes_v2devMNF(netName, nodeNamesIn, nodeNamesOut, dataIn, dataOut, dataInErr)
    pred.dataInErr = dataInErr;
else
    fprintf('predicting using data values\n')
    pred = predictBayes_v2devMNF(netName, nodeNamesIn, nodeNamesOut, dataIn, dataOut)
    pred.dataInErr = [];
end
